...
parser.add_argument("--boardSize", help="The length of the board square.", type=int, choices=xrange(3, 27, 2), default=5)
parser.add_argument("--playerCount", help="The total player count.", type=int, choices=xrange(1, 100), default=6)
